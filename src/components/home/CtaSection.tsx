      ...
      <div className="max-w-5xl mx-auto glass-morphism rounded-2xl p-8 md:p-12 bg-gradient-to-br from-urban-dark-2/80 to-urban-dark-3/80">
        <div className="text-center relative">
          ...
          <p className="text-lg md:text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
            Build your custom AI recruiter in minutes. Shortlist, interview, and select talent on autopilot.
          </p>
          ...
          <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
            <div className="p-4">
              ...
              <p className="text-sm text-gray-400">Go live now—no tech skills needed</p>
            </div>
            <div className="p-4">
              <div className="bg-green-500/20 w-12 h-12 rounded-full flex items-center justify-center mx-auto mb-3">
                <svg className="w-6 h-6 text-green-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <h3 className="font-medium mb-1">AI-Driven Decisions</h3>
              <p className="text-sm text-gray-400">Let UrbanRecruiter screen & qualify every applicant</p>
            </div>
            <div className="p-4">
              <div className="bg-green-500/20 w-12 h-12 rounded-full flex items-center justify-center mx-auto mb-3">
                <svg className="w-6 h-6 text-green-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <h3 className="font-medium mb-1">24/7 Automation</h3>
              <p className="text-sm text-gray-400">Interview and update candidates even when you’re offline</p>
            </div>
          </div>
          <p className="text-sm text-gray-400 mt-6">
            No credit card required. Enjoy a 14-day free trial with unlimited hiring.
          </p>
        </div>
      </div>
